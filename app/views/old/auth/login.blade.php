...
@section('content')
	@include('auth.partials.header', array('title' => 'Inloggen'))

	<div class="row">
		<div class="col-sm-6">
			{{ Form::open(array('action' => 'auth.controller@login', 'method' => 'post')) }}
				...
				<a href="{{ action('auth.controller@showReminder') }}" class="btn btn-default">Wachtwoord vergeten</a>
			{{ Form::close() }}
		</div>
		<div class="col-sm-6">
